	...
	export default {
		...
		methods: {
			checkKeepRunning() {
				...
				let lastTimestamp = Number(sessionStorage[this.uniqueKey + '_$uCountDownTimestamp']);
				...
				if(this.keepRunning && lastTimestamp && lastTimestamp > nowTimestamp) {
					...
					delete sessionStorage[this.uniqueKey + '_$uCountDownTimestamp']
					// 开始倒计时
					this.start();
				} else {
			...
			setTimeToStorage() {
				...
				if(this.secNum > 0 && this.secNum <= this.seconds) {
					...
					// })
					sessionStorage[this.uniqueKey + '_$uCountDownTimestamp'] = nowTimestamp + Number(this.secNum)
				}
			}
		},
