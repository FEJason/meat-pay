              ...
              <div class="account-item">
                <div class="account-item-in">
                  ...
                  >
                    ...
                    <!-- 待审核 -->
                    <span style="color: #828ea1; font-size: 13px"> 待审核 </span>
                  </div>
              ...
              <div class="account-item">
                <div class="account-item-in">
                  ...
                  <div class="right u-flex u-row-between">
                    ...
                    <a class="btn" @click="capitalPsShow = true" v-if="!securityInfo.tradeSetting[0]">{{ $t("uc.safe.set") }}</a>
                    <a class="btn" @click="capitalPsShowa = true" v-else>修改</a>
                  </div>
                </div>
