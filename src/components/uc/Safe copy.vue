                                ...
                                <div class="detail-list">
                                    <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="110">
                                        ...
                                        <FormItem :label="$t('otc.publishad.country')" prop="country">
                                            <Select v-model="formValidate3.country" style="width: 95px;border-bottom: 1px solid #27313e;float:left;">
  ...
  methods: {
    ...
    submit(name) {
      ...
      if (name == "formValidate3") {
        let param = {};
          if(!this.formValidate3.country){
              this.$Message.error($t("uc.regist.countrytip"));
          }
        param["country"] = this.formValidate3.country;
