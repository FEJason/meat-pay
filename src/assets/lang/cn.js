module.exports = {
    ...
    home: {
        ...
        ckgd: '查看更多',
        jrjaq: '金融级安全',
        qfw: '全方位金融风控系统和防盗系统，冷热钱包、多签系统保证资金安全',
        jscz: '极速充提',
        cztx: '充值提现最快3分钟完成，24H人工在线审核，保护客户不错过最佳投资机会',
        qqfw: '全球服务',
        qqyw: '全球业务服务网络覆盖，助您投资全球加密资产，与全球用户交易',
        yxzc: '严选资产',
        ygxz: '严格选择优质加密项目，为您过滤80%极高风险项目',
        sssd: '随时随地开启安全交易',
        smxz: '扫码下载',
        jyd: '交易对',
        jg: '价格',
    ...
    orderInfo: {
        ...
        bkck: '订单已取消，不可查看支付方式',
        ryyw: '如有疑问请联系客服',
        mjzsxm: '卖家真实姓名，请使用本人账户向商家付款；',
        xmjfk: '向卖家付款必须备注参考号，否则无法识别您付款；',
