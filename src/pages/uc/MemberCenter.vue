        ...
        <Col :xs="24" :sm="24" :md="4" :lg="4">
          ...
          >
            ...
            <Submenu name="2">
              ...
              <!-- <MenuItem name="2-10">
                <router-link to="/uc/swapAssets">{{
                  $t("uc.finance.swapassets")
                }}</router-link>
              </MenuItem> -->
              <MenuItem name="2-2">
              ...
              <!-- <MenuItem name="2-9">
                <router-link to="/uc/quickExchange">{{
                  $t("uc.finance.record.quickExchange")
                }}</router-link>
              </MenuItem> -->
              <!-- 充币 -->
              <MenuItem name="2-3">
    ...
    >
      ...
      >
        ...
        <Submenu name="6">
          ...
          <MenuItem name="6-3">
            <router-link to="/uc/innovation/mylocked">{{
              $t("uc.activity.subNavTitle3")
            }}</router-link>
          </MenuItem>
        </Submenu>
      </Menu>
