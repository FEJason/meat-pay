<template>
  <div class="login_form app-download">
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://bizzanss.oss-cn-hangzhou.aliyuncs.com/2019/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "zh_CN" ? "APP下载 - " : "APP Download - ") + "BTXCHAIN | Global digital currency trading platform";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://www.btxchain.com/app";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
