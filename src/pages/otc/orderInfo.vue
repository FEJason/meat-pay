      ...
      <div class="content">
        <div class="tit u-p-20 u-flex u-row-between">
          ...
          <div class="u-font-20 u-font-bold" v-if="orderInfo.status == 1">
            <!-- 待我支付-->
            <!-- 我买 or 商家买入 (side == 1 && adSide == null) || (side == 1 && adSide == 1) -->
            <div v-if="(orderInfo.side == 1 && orderInfo.adSide == null) || (orderInfo.side == 1 && orderInfo.adSide == 1)">{{ $t('orderInfo.dwzf') }}</div>
            <!-- 待对方支付 -->
            <!-- 我卖 or 商家卖出 (side == 2 && adSide == null) || (side == 1 && adSide == 2) -->
            <div v-if="(orderInfo.side == 2 && orderInfo.adSide == null) || (orderInfo.side == 1 && orderInfo.adSide == 2)">{{ $t('orderInfo.ddfzf') }}</div>
            <div>
              <div class="u-font-14">
                <u-count-down
                  ref="uCount"
        ...
        <div class="info u-p-20">
          ...
          <div class="u-flex u-p-t-30">
            ...
            <span class="u-flex-1" style="height: 1px; border-bottom: 1px solid #515a6e"></span>
          </div>
          <div v-if="orderInfo.status != 0">
            <div class="init u-flex u-m-t-30"
              v-if="(orderInfo.side == 1 && orderInfo.adSide == null) || (orderInfo.side == 1 && orderInfo.adSide == 1)"
              >
            ...
            <div class="u-flex u-m-t-30">
              ...
              <div v-if="orderInfo.status == 2 && orderInfo.side == 1">
                ...
                <Button type="primary">{{ $t('orderInfo.ss') }}</Button>
              </div>
            </div>
